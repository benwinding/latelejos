...
\begin{document}
	...
	\begin{tabular}{|p{2.1cm}|p{2.5cm}|p{2cm}|p{4.1cm}|}		
		...
		Ben & 2-Oct-2017 & 0.10 & Revised the figures position\\ \hline
		Issac Lee & 3-Oct-2017 & 0.11 & Fixed some symbols display issue and Revised the introduction and resource estimate sections\\ \hline
		\hline 
		\hline 		
	\end{tabular}
