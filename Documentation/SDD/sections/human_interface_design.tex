...
\begin{tabular}{|l|l|l|l|}
	\hline
	\textbf{Figure Number}            & \textbf{Image of panels} & \textbf{Name} \\ 
	\hline
	\textbf{Fig 11}  & \parbox[c]{1em}{\includegraphics[width=30mm]{Systemstatus.png}} & System Status  \\ 
	\hline
	\textbf{Fig 12} & \parbox[c]{1em}{\includegraphics[width=30mm]{SystemLog.png}} & System Log \\ 
	\hline
\end{tabular}
