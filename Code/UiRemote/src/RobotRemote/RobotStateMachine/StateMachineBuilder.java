...
public class StateMachineBuilder {
    ...
    ServiceManager sm;
    ManualStopped state_manualStopped;
  ...
  private void OnEveryEvent(Object event) {
    ...
    {
        Logger.log("OnSwitch to Manual Mode...");
    ...
    {
        Logger.log("OnSwitch to AutoSurvey Mode...");
    ...
    private void OnSTOP(EventEmergencySTOP event) {
        //Switch to idle mode
        Logger.log("OnSwitch to Idle Mode...");
        this.state_manualMoving.Leave();
        this.state_autoSurveying.Leave();
    }
}
